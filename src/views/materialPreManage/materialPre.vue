    ...
    <div class="p-2">
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            ...
            <el-table :data="tableData.slice(
                ...
                <el-table-column prop="CreateBy" :label="$t('materialPre.createBy')"
        ...
        <el-dialog v-model="addVisible" :title="$t('materialPre.add')" width="75%" align-center :append-to-body="true"
            ...
            <el-form ref="addFormRef" :inline="true" :model="addForm" :size="'small'" label-width="auto">
                ...
                <el-table :data="addForm.listItem" size="small" :style="{ width: '100%' }" height="300px"
                    ...
                    <el-table-column prop="MaterialDec" :label="$t('materialPre.MaterialDec')"
                        :show-overflow-tooltip="true" />
                    <el-table-column prop="MaterialSpecifications" :label="$t('materialPre.MaterialSpecifications')"
                        width="80" />
        ...
        <el-dialog v-model="editVisible" :title="$t('materialPre.detail')" width="75%" align-center
            :append-to-body="true" :close-on-click-modal="false" :close-on-press-escape="false" @close="closeEdit">
            ...
            <el-form-item :label="$t('materialPre.Notes')" prop="Notes">
                <el-input v-model="editForm.Notes" placeholder="" type="textarea" :rows="3" disabled style="width: 100%;"/>
            </el-form-item>
            <template #footer>
                <span class="dialog-footer">
        ...
        <el-dialog v-model="previewOrderVisible" :title="'备料打印预览'" width="80%" :append-to-body="true"
...
const submitPrint = () => {
    ...
    DownloadMaterialPreplanNoReport(order.MaterialPreplanNo).then((res: any) => {
        if (res.success) {
...
const handleEdit = (row: any) => {
    ...
    QueryMaterialPreplanDelInfo({ MaterialPreplanNO: row.MaterialPreplanNo }).then((res: any) => {
        ...
        editForm.value.Notes = res.content[0].ES_Notes
    });
